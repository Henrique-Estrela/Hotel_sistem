    ...
    * Obs: a modificaçõo ocorre no registro da reserva que contenha o id inserido na reserva instanciada
    ...
    public void alterarReserva(Reserva reserva) {
        ...
        try {
            ...
            ps.setInt(2, reserva.getIdAtendente());
            ps.setInt(3, reserva.getIdQuarto());
            ps.setInt(4, reserva.getIdFormaPagamento());
            ps.setString(5, null);
            if (reserva.getDataCheckin() != null) {
                ps.setString(5, Timestamp.valueOf(reserva.getDataCheckin()).toString());
            }

            ps.setString(6, null);
            if (reserva.getDataCheckout() != null) {
                ps.setString(6, Timestamp.valueOf(reserva.getDataCheckout()).toString());
            }

            ps.setInt(7, reserva.getNumHospedes());
            ps.setDouble(8, reserva.getValorPagamento());
            ps.setBoolean(9, reserva.estaPago());
            ps.setInt(10, reserva.getNum());
